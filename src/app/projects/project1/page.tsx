      ...
      <section aria-label="Project1 preview images" className="space-y-4">
        ...
        <div className="grid place-items-center gap-4 md:grid-cols-3">
          {projectImages.map((image, index) => (
            <div
              key={image.src}
              className={`aspect-square w-full max-w-[220px] overflow-hidden rounded-2xl border bg-card shadow-sm transition-transform duration-300 hover:rotate-0 sm:max-w-[240px] md:max-w-[260px] ${
                index % 2 === 0
